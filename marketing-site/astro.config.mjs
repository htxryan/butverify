  ...
  integrations: [
    ...
    starlight({
      ...
      head: [
        ...
        {
          tag: "meta",
          attrs: { property: "og:image:alt", content: "butverify docs" },
        },
        {
          tag: "meta",
        ...
        {
          tag: "meta",
          attrs: { name: "twitter:image:alt", content: "butverify docs" },
        },
      ],
      sidebar: [
        {
          ...
          items: [
            ...
            {
              label: "Push your first site",
              slug: "docs/quickstart/first-push",
            },
            { label: "View it in a browser", slug: "docs/quickstart/view" },
            {
              label: "JSON output for agents",
              slug: "docs/quickstart/json-output",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Public API", slug: "docs/reference/api" },
            { label: "bv evidence", slug: "docs/reference/evidence" },
            {
              label: "bv install-skill claude",
              slug: "docs/reference/install-skill",
            },
